...
*Standup Jack* nos permite realizar la daily de forma sencilla y asíncrona, mediante 4 preguntas que se envían directamente al canal #daily de Slack. *Geekbot* te pregunta cómo estás, qué se hizo el día anterior, cuáles son las tareas planteadas a completar en el día y si se ha encontrado algún bloqueo. Esta forma de hacer la *daily* nos aporta flexibilidad, ya que:
...
- **¿Has encontrado algún bloqueo?**
    ...
    ✏️ **Recuerda:** para mencionar a una persona el Slack basta con poner
...
✏️ Puedes conocer más en **i. Herramientas** sobre cómo nos organizamos en [Notion](tools/notion.md) y
